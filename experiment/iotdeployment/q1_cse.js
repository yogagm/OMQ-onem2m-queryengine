...
unirest.post(url + "/mn-0/sysmon/cpu_temp").headers(subscribe_headers).send(subscribe_body).end();
...
unirest.post(url + "/mn-1/sysmon/cpu_temp").headers(subscribe_headers).send(subscribe_body).end();
